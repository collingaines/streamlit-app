...
if userPosition!=None: 
    ...
    if userPosition=='Operations Manager':
        ...
        #region CLICK HERE TO EXPAND SECTION 
        st.title('Data Reports & Analytics')


        st.markdown(
            """
            A portal for viewing customized reports and analytics tools.
        """
        )
        st.divider()
        ...
        st.subheader("Select the Report Type:")
        ...
        with col1: 
            ...
            reportOptions = st.selectbox(
            "Select a Report Type",
            ("Bonus Report - Trade Superintendent", 
             "Bonus Report - Foreman", 
             "Bonus Report - Project Trade Pool",
             "Trade Superintendent - Project/Cost Code Breakdown", 
             "Trade Superintendent - Foreman Breakdown", 
             "Trade Superintendent - Project/Cost Type Breakdown",
             "Trade Superintendent - All Cost Code Data",
             "Foreman - Project/Cost Code Breakdown",
             "Foreman - All Cost Code Data"
             ),
            index=None,
        ...
        #==============================================================================================================================
        #"Select an Employee" Dropdown menu: 
        #region

        with col2: 
            #=======================================================================
            #Building lists of all trade supers, foremen, and projects to populate our dropdown menus:

            #===============================
            #Trade Supers & Foremen: 
            userQuery = c.execute("SELECT * FROM Users")
            userValues = c.fetchall()

            foremanList = ["ALL Foremen"]
            tradeSuperList = ["ALL Trade Superintendents"]

            for i in range(len(userValues)):
                employeeName = userValues[i][2]
                employeeTrade = userValues[i][5]
                employeePosition = userValues[i][6]
                employmentStatus = userValues[i][7]

                if employeePosition=='Foreman' and employmentStatus=="Employed":
                    foremanList.append(employeeName)
                if employeePosition=='Craft Superintendent' and employmentStatus=="Employed":
                    tradeSuperList.append(employeeTrade+' - '+employeeName)

            #Converting our lists into tuples to be fed into our dropdown menu options:
            foremanTuple = tuple(foremanList)
            tradeSuperTuple = tuple(tradeSuperList)

            #===============================
            #Projects: 
            projectQuery = c.execute("SELECT * FROM Projects WHERE projectStatus='{}'".format('Active'))
            projectValues = c.fetchall()

            projectList = ["ALL Projects"]

            for i in range(len(projectValues)):
                projectName = projectValues[i][1]

                projectList.append(projectName)

            #Converting our lists into tuples to be fed into our dropdown menu options:
            projectTuple = tuple(projectList)

            #=======================================================================
            #Select an Employee Dropdown for Trade Super Reports:
            if reportOptions in ["Bonus Report - Trade Superintendent", "Trade Superintendent - Project/Cost Code Breakdown", "Trade Superintendent - Foreman Breakdown", "Trade Superintendent - Project/Cost Type Breakdown", "Trade Superintendent - All Cost Code Data"]:
                employeeOptions = st.selectbox(
                "Select an Employee",
                tradeSuperTuple,
                index=None,
                placeholder="Select bonus period...",
            ...
            #=======================================================================
            #Select an Employee Dropdown for Foreman Reports:
            elif reportOptions in ["Bonus Report - Foreman", "Foreman - Project/Cost Code Breakdown", "Foreman - All Cost Code Data"]:
                employeeOptions = st.selectbox(
                "Select an Employee",
                foremanTuple,
                index=None,
            ...
            #=======================================================================
            #Select an Employee Dropdown for Project Reports:
            elif reportOptions in ["Bonus Report - Project Trade Pool"]:
                employeeOptions = st.selectbox(
                "Select an Employee",
                projectTuple,
                index=None,
            ...
            #=======================================================================
            #If no report type has been selected:
            else:
                employeeOptions = st.selectbox(
                "Select an Employee",
                ("*Select a report type to see a list of available employees"),
                index=None,
                placeholder="Select bonus period...",
                )
        ...
        with col1: 
            ...
            st.markdown("**Report:**")
            st.warning("{}".format(reportOptions))

        with col2:
            #===========
            #Month selectbox:
            st.markdown("**Filter Period:**")
            st.warning("{}".format(periodSelection))
            
        with col3:
            #===========
            #Month selectbox:
            st.markdown("**Employee Selection:**")
            st.warning("{}".format(employeeOptions))
        ...
        if reportOptions=='Bonus Report - Trade Superintendent':
            #=====================================================================================================================================================================================
            #=====================================================================================================================================================================================
            #SECTION D-0 | Top of page summary values:
            #region 
            ...
            #=================================================================
            #Querying our database for our values:
            #region
            
            #==============================
            #If our filter selection is a bonus period we will pull data from our "Master_CostCode_Data" database: 
            if 'Q' in periodSelection:
                #If all trade supers have been selected, then we will just query the database for the filter period:
                if employeeOptions=='ALL Trade Superintendents':
                    query = c.execute("SELECT * FROM Master_CostCode_Data WHERE bonusPeriod='{}'".format(periodSelection))
                    values = c.fetchall()
                #If no employee has been selected, we want to default to the "All Trade Superintendents" employee so that the app doesn't throw off an error:
                elif employeeOptions==None:
                    query = c.execute("SELECT * FROM Master_CostCode_Data WHERE bonusPeriod='{}'".format(periodSelection))
                    values = c.fetchall()
                    #If the user hasn't selected an employee option yet, we want to make the system default to all trade supers
                    employeeOptions=='ALL Trade Superintendents'
                #If an individual trade super has been selected, then we will query the database for the filter trade AND filter period:
                else:
                    filterTrade = employeeOptions[0:employeeOptions.index('-')-1]

                    query = c.execute("SELECT * FROM Master_CostCode_Data WHERE ccTrade='{}' and bonusPeriod='{}'".format(filterTrade, periodSelection))
                    values = c.fetchall()
            ...
            if 'Q' in periodSelection:
                ...
                #If an individual trade super has been selected, then we will query the database for the filter trade AND filter period:
                    ...
                    tradeSuperBonusQuery = c.execute("SELECT * FROM Trade_Superintendent_Bonus_Summary WHERE trade='{}' and bonusPeriod='{}'".format(filterTrade, periodSelection))
                    tradeSuperBonusValues = c.fetchall()
            ...
            #Trade $O/U Budget
            with col1:
                st.markdown("**Total Trade $O/U Budget**")
            ...
            #PF:
            with col2:
                st.markdown("**Average Trade Super Bonus**")
            ...
            #Paperwork:
            with col3:
                st.markdown("**Average Foreman Bonus**")
            ...
            if "Q" in periodSelection:
                ...
                for i in range(len(tradeSuperBonusValues)):
                    ...
                    if key in tradeSuperValuesDict:
                        ...
                        tradeSuperValuesDict[(tradeSuper, trade, ccType)] = [newCost, newEarned, newOUbudget, newPF, '', newSafetyIncidents, newBasePFdelta, newPerformanceBonus, newPaperworkDeduct, newSafetyDeduct, newTotalPoolShare, newTotalTotalBonus, projectedBonus]
                    #If not, we will add these values straight to our dictionary:
                    else:
                        tradeSuperValuesDict[(tradeSuper, trade, ccType)] = [totalCost, totalEarned, totalOUbudget, totalPF, '', totalSafetyIncidents, totalBasePFdelta, totalPerformanceBonus, totalPaperworkDeduct, totalSafetyDeduct, totalPoolShare, totalTotalBonus, projectedBonus]
                    ...
                    if totalsKey in tradeSuperValuesDict:
                        ...
                        tradeSuperValuesDict[totalsKey] = [newCost, newEarned, newOUbudget, newPF, newPaperwork, newSafetyIncidents, newBasePFdelta, newPerformanceBonus, newPaperworkDeduct, newSafetyDeduct, newTotalPoolShare, newTotalTotalBonus, projectedBonus]
                    ...
                    #If not, we will add these values straight to our dictionary:
                        ...
                        tradeSuperValuesDict[totalsKey] = [totalCost, totalEarned, totalOUbudget, totalPF, newPaperwork, totalSafetyIncidents, totalBasePFdelta, totalPerformanceBonus, totalPaperworkDeduct, totalSafetyDeduct, totalPoolShare, totalTotalBonus, projectedBonus]
            ...
            #If our filter selection is for a CTC period, we are just going to pull the needed values from our database and add them to the list:
                ...
                for i in range(len(tradeSuperBonusValues)):
                    ...
                    tradeSuperValuesDict[(tradeSuper, trade, ccType)] = [totalCost, totalEarned, totalOUbudget, totalPF, totalPaperwork, totalSafetyIncidents, totalBasePFdelta, totalPerformanceBonus, totalPaperworkDeduct, totalSafetyDeduct, totalPoolShare, totalTotalBonus, projectedBonus]
            ...
            for i in range(len(keyList)):
                ...
                if "-" in ccType: 
                    ...
                    #Updating our list:
                    data_values.append([ccType, totalCost, totalEarned, totalOUbudget, totalPF, newPaperwork, safetyIncidents, basePFdelta, performanceBonus, paperworkDeduct, safetyDeduct, poolShare, totalBonus, totalProjectBonus])
            ...
            column_headers = ['Trade Superintendent/CC Type', 'Total Cost       ', 'Total Earned      ', '$O/U Budget', 'PF', 'Paperwork %       ', 'Safety Incidents', 'Base PF Delta', 'Performance Bonus', 'PW Deduct', 'Safety Deduct', 'Pool Share', 'Total Bonus', 'Projected Bonus']
            ...
            def highlight_and_bold_rows(row):
                value_to_highlight = ['Concrete - Christopher Roberts', 'Earthwork - Gabino Gonzalez', 'Utilities - Miguel Soto', 'Utilities - Adrian Mosqueda']
            ...
            st.subheader("Trade Superintendent Bonus Summary")
            ...
            #========================================================================================================================================
            #SECTION D-5 | Generate cost code summary table and apply formatting:
            #region
            ...
            for i in range(len(costCodeValues)):
                #=======================================
                #Checking if this is a trade cost code:
            ...
            st.subheader("All Trade Superintendent Cost Code Bonus Data")
            AgGrid(
        ...
        #region CLICK HERE TO EXPAND SECTION
        ...
        elif reportOptions=='Bonus Report - Foreman':
            #========================================================================================================================================
                ...
                for i in range(len(foremanBonusValues)):
                    ...
                    if foremanName in foremanNameList:
                        ...
                        if key in foremanValueDictionary:
                            ...
                            foremanValueDictionary[key] = [newCost, newEarned, newOUbudget, newPF, newPaperwork, newSafetyIncidents, newBasePFdelta, newPerformanceBonus, newPaperworkDeduct, newSafetyDeduct, newTotalPoolShare, newTotalTotalBonus, projectedBonus, foremanTrade]
                        #If not, we will add these values straight to our dictionary:
                        else:
                            foremanValueDictionary[key] = [totalCost, totalEarned, totalOUbudget, totalPF, totalPaperwork, totalSafetyIncidents, totalBasePFdelta, totalPerformanceBonus, totalPaperworkDeduct, totalSafetyDeduct, totalPoolShare, totalTotalBonus, projectedBonus, foremanTrade]
            ...
            #region
            column_headers = ['Foreman Name', 'Trade', 'Total Cost', 'Total Earned', '$O/U Budget', 'PF', 'Paperwork', 'Safety Incidents', 'Base PF Delta', 'Performance Bonus', 'PW Deduct', 'Safety Deduct', 'Pool Share', 'Total Bonus', 'Projected Bonus']
            ...
            for key,values in foremanValueDictionary.items():
                ...
                data_values.append([foreman, trade, totalCost, totalEarned, totalOUbudget, totalPF, newPaperwork, safetyIncidents, basePFdelta, performanceBonus, paperworkDeduct, safetyDeduct, poolShare, totalBonus, projectedBonus])
            ...
            st.dataframe(
                ...
                column_config={
                    ...
                    'Pool Share': st.column_config.TextColumn('Pool Share', help='Trade superintendents are given 29% of the total trade bonus pool, which is divided equally among all active trade superintendents'),
                    'Total Bonus': st.column_config.TextColumn('Total Bonus', help='Total $ amount of bonus earned for the current bonus period'),
                    'Projected Bonus': st.column_config.TextColumn('Projected Bonus', help='Total projected bonus $ amount for the 6 month bonus period')
                },
                height=600,
                use_container_width=True,
        ...
        #region CLICK HERE TO EXPAND SECTION
        ...
        elif reportOptions=='Bonus Report - Project Trade Pool':         
            #========================================================================================================================================
            ...
            #===========================================================================
            #ANOTHER TRY (USE THIS ONE 1/18/25):
            ...
            data = {
                "Category": ["A", "B", "C", "D"],
                "Revenue": [1200.456, -1500.876, 3000.123, 4500.654],
                "Expenses": [-500.125, -700.678, 1000.890, 2500.456],
                "Profit": [700.331, -800.198, 2000.233, 2000.198],
                "PF":[.9965, .9965, 1.27658, 1.27658],
            }
            ...
            #===========================================================================
            # Round specified columns to the second decimal place
            columns_to_round = ["Revenue", "Expenses", "Profit"]
            ...
            df_with_footer = pd.concat([df, pd.DataFrame([sum_row])], ignore_index=True)
        ...
        #region
            ...
            st.warning("Select a report type, filter period, and employee selection in the section above to generate a report!")
